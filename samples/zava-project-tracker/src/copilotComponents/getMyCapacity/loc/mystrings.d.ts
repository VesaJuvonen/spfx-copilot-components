declare interface IGetMyCapacityCopilotComponentStrings {
...
declare module 'GetMyCapacityCopilotComponentStrings' {
  const strings: IGetMyCapacityCopilotComponentStrings;
  export = strings;
}
