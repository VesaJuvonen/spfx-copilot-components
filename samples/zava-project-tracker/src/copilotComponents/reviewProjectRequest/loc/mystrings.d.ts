declare interface IReviewProjectRequestCopilotComponentStrings {
...
declare module 'ReviewProjectRequestCopilotComponentStrings' {
  const strings: IReviewProjectRequestCopilotComponentStrings;
  export = strings;
}
