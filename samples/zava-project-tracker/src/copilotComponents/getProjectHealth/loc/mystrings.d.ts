declare interface IGetProjectHealthCopilotComponentStrings {
...
declare module 'GetProjectHealthCopilotComponentStrings' {
  const strings: IGetProjectHealthCopilotComponentStrings;
  export = strings;
}
