declare interface ISubmitProjectRequestCopilotComponentStrings {
...
declare module 'SubmitProjectRequestCopilotComponentStrings' {
  const strings: ISubmitProjectRequestCopilotComponentStrings;
  export = strings;
}
