declare interface ISubmitAiUsageCopilotComponentStrings {
...
declare module 'SubmitAiUsageCopilotComponentStrings' {
  const strings: ISubmitAiUsageCopilotComponentStrings;
  export = strings;
}
