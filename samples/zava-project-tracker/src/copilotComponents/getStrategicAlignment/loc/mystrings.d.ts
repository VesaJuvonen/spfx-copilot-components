declare interface IGetStrategicAlignmentCopilotComponentStrings {
...
declare module 'GetStrategicAlignmentCopilotComponentStrings' {
  const strings: IGetStrategicAlignmentCopilotComponentStrings;
  export = strings;
}
