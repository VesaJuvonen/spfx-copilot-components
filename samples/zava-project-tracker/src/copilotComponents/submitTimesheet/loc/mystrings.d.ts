declare interface ISubmitTimesheetCopilotComponentStrings {
...
declare module 'SubmitTimesheetCopilotComponentStrings' {
  const strings: ISubmitTimesheetCopilotComponentStrings;
  export = strings;
}
