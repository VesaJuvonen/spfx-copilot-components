declare interface ISubmitWeeklyUpdateCopilotComponentStrings {
...
declare module 'SubmitWeeklyUpdateCopilotComponentStrings' {
  const strings: ISubmitWeeklyUpdateCopilotComponentStrings;
  export = strings;
}
