declare interface IReviewResourceAssignmentCopilotComponentStrings {
...
declare module 'ReviewResourceAssignmentCopilotComponentStrings' {
  const strings: IReviewResourceAssignmentCopilotComponentStrings;
  export = strings;
}
