declare interface IGetProjectMilestonesCopilotComponentStrings {
...
declare module 'GetProjectMilestonesCopilotComponentStrings' {
  const strings: IGetProjectMilestonesCopilotComponentStrings;
  export = strings;
}
