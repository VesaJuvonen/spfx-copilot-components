declare interface IGetMyWorkSummaryCopilotComponentStrings {
...
declare module 'GetMyWorkSummaryCopilotComponentStrings' {
  const strings: IGetMyWorkSummaryCopilotComponentStrings;
  export = strings;
}
