declare interface IGetMyGoalContributionsCopilotComponentStrings {
...
declare module 'GetMyGoalContributionsCopilotComponentStrings' {
  const strings: IGetMyGoalContributionsCopilotComponentStrings;
  export = strings;
}
