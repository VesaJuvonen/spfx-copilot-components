declare interface IGetPortfolioBudgetForecastCopilotComponentStrings {
...
declare module 'GetPortfolioBudgetForecastCopilotComponentStrings' {
  const strings: IGetPortfolioBudgetForecastCopilotComponentStrings;
  export = strings;
}
