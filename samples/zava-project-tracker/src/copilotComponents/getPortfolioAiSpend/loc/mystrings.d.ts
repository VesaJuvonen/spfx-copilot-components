declare interface IGetPortfolioAiSpendCopilotComponentStrings {
...
declare module 'GetPortfolioAiSpendCopilotComponentStrings' {
  const strings: IGetPortfolioAiSpendCopilotComponentStrings;
  export = strings;
}
