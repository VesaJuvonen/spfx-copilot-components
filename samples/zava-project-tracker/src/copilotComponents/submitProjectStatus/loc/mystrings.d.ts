declare interface ISubmitProjectStatusCopilotComponentStrings {
...
declare module 'SubmitProjectStatusCopilotComponentStrings' {
  const strings: ISubmitProjectStatusCopilotComponentStrings;
  export = strings;
}
