declare interface IReviewStageGateCopilotComponentStrings {
...
declare module 'ReviewStageGateCopilotComponentStrings' {
  const strings: IReviewStageGateCopilotComponentStrings;
  export = strings;
}
