declare interface IGetProjectAiSpendCopilotComponentStrings {
...
declare module 'GetProjectAiSpendCopilotComponentStrings' {
  const strings: IGetProjectAiSpendCopilotComponentStrings;
  export = strings;
}
