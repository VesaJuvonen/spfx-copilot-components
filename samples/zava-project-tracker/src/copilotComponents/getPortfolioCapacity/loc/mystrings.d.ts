declare interface IGetPortfolioCapacityCopilotComponentStrings {
...
declare module 'GetPortfolioCapacityCopilotComponentStrings' {
  const strings: IGetPortfolioCapacityCopilotComponentStrings;
  export = strings;
}
