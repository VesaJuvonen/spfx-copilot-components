declare interface IRequestAiBudgetCopilotComponentStrings {
...
declare module 'RequestAiBudgetCopilotComponentStrings' {
  const strings: IRequestAiBudgetCopilotComponentStrings;
  export = strings;
}
