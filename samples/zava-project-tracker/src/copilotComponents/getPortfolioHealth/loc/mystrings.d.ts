declare interface IGetPortfolioHealthCopilotComponentStrings {
...
declare module 'GetPortfolioHealthCopilotComponentStrings' {
  const strings: IGetPortfolioHealthCopilotComponentStrings;
  export = strings;
}
