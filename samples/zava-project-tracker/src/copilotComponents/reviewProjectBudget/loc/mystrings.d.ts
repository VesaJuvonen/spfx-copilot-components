declare interface IReviewProjectBudgetCopilotComponentStrings {
...
declare module 'ReviewProjectBudgetCopilotComponentStrings' {
  const strings: IReviewProjectBudgetCopilotComponentStrings;
  export = strings;
}
