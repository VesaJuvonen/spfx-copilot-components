...
const definitions = [
  ...
  ['SubmitProjectStatus', 'submitProjectStatus', 'Show an editable five-dimension project status report or status update for human review before submission.', ['projectId', 'reportingDate', 'overallStatus', 'summary', 'accomplishments', 'nextSteps', 'helpNeeded']],
