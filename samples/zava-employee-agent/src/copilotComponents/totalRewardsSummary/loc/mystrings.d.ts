declare interface ITotalRewardsSummaryCopilotComponentStrings {
...
declare module 'TotalRewardsSummaryCopilotComponentStrings' {
  const strings: ITotalRewardsSummaryCopilotComponentStrings;
  export = strings;
}
