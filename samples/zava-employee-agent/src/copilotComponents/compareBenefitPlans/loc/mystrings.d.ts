declare interface ICompareBenefitPlansCopilotComponentStrings {
...
declare module 'CompareBenefitPlansCopilotComponentStrings' {
  const strings: ICompareBenefitPlansCopilotComponentStrings;
  export = strings;
}
