declare interface ICreateHrCaseCopilotComponentStrings {
...
declare module 'CreateHrCaseCopilotComponentStrings' {
  const strings: ICreateHrCaseCopilotComponentStrings;
  export = strings;
}
