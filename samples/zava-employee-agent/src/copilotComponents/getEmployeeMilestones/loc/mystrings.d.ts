declare interface IGetEmployeeMilestonesCopilotComponentStrings {
...
declare module 'GetEmployeeMilestonesCopilotComponentStrings' {
  const strings: IGetEmployeeMilestonesCopilotComponentStrings;
  export = strings;
}
