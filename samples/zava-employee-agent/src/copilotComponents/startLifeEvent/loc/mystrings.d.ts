declare interface IStartLifeEventCopilotComponentStrings {
...
declare module 'StartLifeEventCopilotComponentStrings' {
  const strings: IStartLifeEventCopilotComponentStrings;
  export = strings;
}
