declare interface IGetWorklifeSnapshotCopilotComponentStrings {
...
declare module 'GetWorklifeSnapshotCopilotComponentStrings' {
  const strings: IGetWorklifeSnapshotCopilotComponentStrings;
  export = strings;
}
