declare interface IRequiredLearningCopilotComponentStrings {
...
declare module 'RequiredLearningCopilotComponentStrings' {
  const strings: IRequiredLearningCopilotComponentStrings;
  export = strings;
}
