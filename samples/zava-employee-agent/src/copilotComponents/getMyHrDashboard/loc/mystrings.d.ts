declare interface IGetMyHrDashboardCopilotComponentStrings {
...
declare module 'GetMyHrDashboardCopilotComponentStrings' {
  const strings: IGetMyHrDashboardCopilotComponentStrings;
  export = strings;
}
