declare interface IApprovalInboxCopilotComponentStrings {
...
declare module 'ApprovalInboxCopilotComponentStrings' {
  const strings: IApprovalInboxCopilotComponentStrings;
  export = strings;
}
