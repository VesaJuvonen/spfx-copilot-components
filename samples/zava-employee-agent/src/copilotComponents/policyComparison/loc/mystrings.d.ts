declare interface IPolicyComparisonCopilotComponentStrings {
...
declare module 'PolicyComparisonCopilotComponentStrings' {
  const strings: IPolicyComparisonCopilotComponentStrings;
  export = strings;
}
