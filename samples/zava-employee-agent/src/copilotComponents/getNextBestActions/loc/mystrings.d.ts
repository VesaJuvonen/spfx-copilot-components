declare interface IGetNextBestActionsCopilotComponentStrings {
...
declare module 'GetNextBestActionsCopilotComponentStrings' {
  const strings: IGetNextBestActionsCopilotComponentStrings;
  export = strings;
}
