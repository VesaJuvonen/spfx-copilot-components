declare interface IRequestTimeOffCopilotComponentStrings {
...
declare module 'RequestTimeOffCopilotComponentStrings' {
  const strings: IRequestTimeOffCopilotComponentStrings;
  export = strings;
}
