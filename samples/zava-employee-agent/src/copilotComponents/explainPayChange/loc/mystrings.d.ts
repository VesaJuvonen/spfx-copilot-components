declare interface IExplainPayChangeCopilotComponentStrings {
...
declare module 'ExplainPayChangeCopilotComponentStrings' {
  const strings: IExplainPayChangeCopilotComponentStrings;
  export = strings;
}
