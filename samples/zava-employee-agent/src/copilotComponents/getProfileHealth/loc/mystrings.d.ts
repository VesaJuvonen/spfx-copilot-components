declare interface IGetProfileHealthCopilotComponentStrings {
...
declare module 'GetProfileHealthCopilotComponentStrings' {
  const strings: IGetProfileHealthCopilotComponentStrings;
  export = strings;
}
