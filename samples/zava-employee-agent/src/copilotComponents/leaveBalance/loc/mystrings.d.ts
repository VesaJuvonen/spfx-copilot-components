declare interface ILeaveBalanceCopilotComponentStrings {
...
declare module 'LeaveBalanceCopilotComponentStrings' {
  const strings: ILeaveBalanceCopilotComponentStrings;
  export = strings;
}
