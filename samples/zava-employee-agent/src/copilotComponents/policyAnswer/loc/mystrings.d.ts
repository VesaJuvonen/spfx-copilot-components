declare interface IPolicyAnswerCopilotComponentStrings {
...
declare module 'PolicyAnswerCopilotComponentStrings' {
  const strings: IPolicyAnswerCopilotComponentStrings;
  export = strings;
}
