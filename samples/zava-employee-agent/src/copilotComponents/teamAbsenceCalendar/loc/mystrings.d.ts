declare interface ITeamAbsenceCalendarCopilotComponentStrings {
...
declare module 'TeamAbsenceCalendarCopilotComponentStrings' {
  const strings: ITeamAbsenceCalendarCopilotComponentStrings;
  export = strings;
}
