declare interface IGetInnovationGrowthCopilotComponentStrings {
...
declare module 'GetInnovationGrowthCopilotComponentStrings' {
  const strings: IGetInnovationGrowthCopilotComponentStrings;
  export = strings;
}
