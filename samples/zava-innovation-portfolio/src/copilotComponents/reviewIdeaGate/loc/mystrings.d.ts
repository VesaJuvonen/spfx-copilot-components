declare interface IReviewIdeaGateCopilotComponentStrings {
...
declare module 'ReviewIdeaGateCopilotComponentStrings' {
  const strings: IReviewIdeaGateCopilotComponentStrings;
  export = strings;
}
