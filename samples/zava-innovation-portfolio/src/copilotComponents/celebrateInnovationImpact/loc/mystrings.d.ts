declare interface ICelebrateInnovationImpactCopilotComponentStrings {
...
declare module 'CelebrateInnovationImpactCopilotComponentStrings' {
  const strings: ICelebrateInnovationImpactCopilotComponentStrings;
  export = strings;
}
