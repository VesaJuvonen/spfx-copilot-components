declare interface IGenerateInnovationBriefCopilotComponentStrings {
...
declare module 'GenerateInnovationBriefCopilotComponentStrings' {
  const strings: IGenerateInnovationBriefCopilotComponentStrings;
  export = strings;
}
