declare interface IExploreGlobalInnovationCopilotComponentStrings {
...
declare module 'ExploreGlobalInnovationCopilotComponentStrings' {
  const strings: IExploreGlobalInnovationCopilotComponentStrings;
  export = strings;
}
