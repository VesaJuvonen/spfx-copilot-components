declare interface IBuildIdeaBusinessCaseCopilotComponentStrings {
...
declare module 'BuildIdeaBusinessCaseCopilotComponentStrings' {
  const strings: IBuildIdeaBusinessCaseCopilotComponentStrings;
  export = strings;
}
