declare interface ITrackInnovationBudgetCopilotComponentStrings {
...
declare module 'TrackInnovationBudgetCopilotComponentStrings' {
  const strings: ITrackInnovationBudgetCopilotComponentStrings;
  export = strings;
}
