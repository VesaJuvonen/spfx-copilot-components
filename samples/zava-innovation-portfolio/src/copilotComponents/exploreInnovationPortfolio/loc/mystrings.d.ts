declare interface IExploreInnovationPortfolioCopilotComponentStrings {
...
declare module 'ExploreInnovationPortfolioCopilotComponentStrings' {
  const strings: IExploreInnovationPortfolioCopilotComponentStrings;
  export = strings;
}
