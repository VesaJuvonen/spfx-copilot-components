declare interface ISubmitInnovationIdeaCopilotComponentStrings {
...
declare module 'SubmitInnovationIdeaCopilotComponentStrings' {
  const strings: ISubmitInnovationIdeaCopilotComponentStrings;
  export = strings;
}
