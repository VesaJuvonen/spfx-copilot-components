declare interface IManageInnovationExperimentCopilotComponentStrings {
...
declare module 'ManageInnovationExperimentCopilotComponentStrings' {
  const strings: IManageInnovationExperimentCopilotComponentStrings;
  export = strings;
}
