...
import type { IReviewProposalReadinessProps } from './IReviewProposalReadinessProps';
 ...
 */
export default function ReviewProposalReadiness(props: IReviewProposalReadinessProps): React.ReactElement {
  const {
