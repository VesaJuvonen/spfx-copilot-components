declare interface IReviewProposalReadinessCopilotComponentStrings {
...
declare module 'ReviewProposalReadinessCopilotComponentStrings' {
  const strings: IReviewProposalReadinessCopilotComponentStrings;
  export = strings;
}
