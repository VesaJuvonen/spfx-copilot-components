...
const schema = z.object({
  ...
  proposalId: z.string().optional().describe('proposalId extracted from the user request when provided.'),
...
export type IReviewProposalReadinessCopilotComponentProperties = z.infer<typeof schema>;
