...
export interface ICreateExecutiveEngagementPlanStrings {
...
export interface ICreateExecutiveEngagementPlanProps {
  ...
  strings: ICreateExecutiveEngagementPlanStrings;
}
