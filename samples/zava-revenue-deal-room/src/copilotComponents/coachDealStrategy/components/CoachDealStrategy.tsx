...
import type { ICoachDealStrategyProps } from './ICoachDealStrategyProps';
 ...
 */
export default function CoachDealStrategy(props: ICoachDealStrategyProps): React.ReactElement {
  const {
