...
import type { IMapBuyingCommitteeProps } from './IMapBuyingCommitteeProps';
 ...
 */
export default function MapBuyingCommittee(props: IMapBuyingCommitteeProps): React.ReactElement {
  const {
