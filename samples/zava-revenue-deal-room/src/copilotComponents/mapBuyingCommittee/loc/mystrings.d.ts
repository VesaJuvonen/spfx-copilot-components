declare interface IMapBuyingCommitteeCopilotComponentStrings {
...
declare module 'MapBuyingCommitteeCopilotComponentStrings' {
  const strings: IMapBuyingCommitteeCopilotComponentStrings;
  export = strings;
}
