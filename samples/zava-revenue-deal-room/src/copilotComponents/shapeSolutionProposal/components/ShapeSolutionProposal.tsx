...
import type { IShapeSolutionProposalProps } from './IShapeSolutionProposalProps';
 ...
 */
export default function ShapeSolutionProposal(props: IShapeSolutionProposalProps): React.ReactElement {
  const {
