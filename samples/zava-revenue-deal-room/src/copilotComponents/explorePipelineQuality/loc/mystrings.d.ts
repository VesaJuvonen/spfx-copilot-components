declare interface IExplorePipelineQualityCopilotComponentStrings {
...
declare module 'ExplorePipelineQualityCopilotComponentStrings' {
  const strings: IExplorePipelineQualityCopilotComponentStrings;
  export = strings;
}
