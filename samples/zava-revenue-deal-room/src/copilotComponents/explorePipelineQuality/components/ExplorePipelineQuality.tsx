...
import type { IExplorePipelineQualityProps } from './IExplorePipelineQualityProps';
 ...
 */
export default function ExplorePipelineQuality(props: IExplorePipelineQualityProps): React.ReactElement {
  const {
