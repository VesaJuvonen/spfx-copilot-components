declare interface IGetDealRiskCopilotComponentStrings {
...
declare module 'GetDealRiskCopilotComponentStrings' {
  const strings: IGetDealRiskCopilotComponentStrings;
  export = strings;
}
