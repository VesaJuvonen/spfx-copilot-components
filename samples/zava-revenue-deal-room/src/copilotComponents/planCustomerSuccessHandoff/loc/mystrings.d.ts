declare interface IPlanCustomerSuccessHandoffCopilotComponentStrings {
...
declare module 'PlanCustomerSuccessHandoffCopilotComponentStrings' {
  const strings: IPlanCustomerSuccessHandoffCopilotComponentStrings;
  export = strings;
}
