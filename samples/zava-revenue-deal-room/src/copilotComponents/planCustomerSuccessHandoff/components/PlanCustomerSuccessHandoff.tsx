...
import type { IPlanCustomerSuccessHandoffProps } from './IPlanCustomerSuccessHandoffProps';
 ...
 */
export default function PlanCustomerSuccessHandoff(props: IPlanCustomerSuccessHandoffProps): React.ReactElement {
  const {
