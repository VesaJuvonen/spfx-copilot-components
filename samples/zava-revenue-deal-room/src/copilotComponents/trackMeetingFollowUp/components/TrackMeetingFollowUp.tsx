...
import type { ITrackMeetingFollowUpProps } from './ITrackMeetingFollowUpProps';
 ...
 */
export default function TrackMeetingFollowUp(props: ITrackMeetingFollowUpProps): React.ReactElement {
  const {
