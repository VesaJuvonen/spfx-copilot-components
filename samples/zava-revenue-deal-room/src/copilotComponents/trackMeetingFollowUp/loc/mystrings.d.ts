declare interface ITrackMeetingFollowUpCopilotComponentStrings {
...
declare module 'TrackMeetingFollowUpCopilotComponentStrings' {
  const strings: ITrackMeetingFollowUpCopilotComponentStrings;
  export = strings;
}
