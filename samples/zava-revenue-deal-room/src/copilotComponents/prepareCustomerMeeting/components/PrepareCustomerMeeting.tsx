...
import type { IPrepareCustomerMeetingProps } from './IPrepareCustomerMeetingProps';
 ...
 */
export default function PrepareCustomerMeeting(props: IPrepareCustomerMeetingProps): React.ReactElement {
  const {
