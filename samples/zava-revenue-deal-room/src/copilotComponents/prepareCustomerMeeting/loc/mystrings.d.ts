declare interface IPrepareCustomerMeetingCopilotComponentStrings {
...
declare module 'PrepareCustomerMeetingCopilotComponentStrings' {
  const strings: IPrepareCustomerMeetingCopilotComponentStrings;
  export = strings;
}
