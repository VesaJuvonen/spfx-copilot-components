declare interface IQualifyOpportunityCopilotComponentStrings {
...
declare module 'QualifyOpportunityCopilotComponentStrings' {
  const strings: IQualifyOpportunityCopilotComponentStrings;
  export = strings;
}
