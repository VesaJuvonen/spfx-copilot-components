...
import type { IQualifyOpportunityProps } from './IQualifyOpportunityProps';
 ...
 */
export default function QualifyOpportunity(props: IQualifyOpportunityProps): React.ReactElement {
  const {
