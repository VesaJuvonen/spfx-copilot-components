...
import type { IExploreAgentCapabilitiesProps } from './IExploreAgentCapabilitiesProps';
 ...
 */
export default function ExploreAgentCapabilities(props: IExploreAgentCapabilitiesProps): React.ReactElement {
  const {
