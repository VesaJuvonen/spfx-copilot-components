declare interface IBuildValueCaseCopilotComponentStrings {
...
declare module 'BuildValueCaseCopilotComponentStrings' {
  const strings: IBuildValueCaseCopilotComponentStrings;
  export = strings;
}
