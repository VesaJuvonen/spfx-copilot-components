...
import type { IInspectForecastCommitProps } from './IInspectForecastCommitProps';
 ...
 */
export default function InspectForecastCommit(props: IInspectForecastCommitProps): React.ReactElement {
  const {
