declare interface IBuildMutualActionPlanCopilotComponentStrings {
...
declare module 'BuildMutualActionPlanCopilotComponentStrings' {
  const strings: IBuildMutualActionPlanCopilotComponentStrings;
  export = strings;
}
