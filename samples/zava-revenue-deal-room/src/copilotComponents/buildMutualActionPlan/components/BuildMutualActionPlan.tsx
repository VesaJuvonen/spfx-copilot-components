...
import type { IBuildMutualActionPlanProps } from './IBuildMutualActionPlanProps';
 ...
 */
export default function BuildMutualActionPlan(props: IBuildMutualActionPlanProps): React.ReactElement {
  const {
