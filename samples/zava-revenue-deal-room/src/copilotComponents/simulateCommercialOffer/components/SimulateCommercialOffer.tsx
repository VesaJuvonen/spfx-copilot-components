...
import type { ISimulateCommercialOfferProps } from './ISimulateCommercialOfferProps';
 ...
 */
export default function SimulateCommercialOffer(props: ISimulateCommercialOfferProps): React.ReactElement {
  const {
