declare interface ISimulateCommercialOfferCopilotComponentStrings {
...
declare module 'SimulateCommercialOfferCopilotComponentStrings' {
  const strings: ISimulateCommercialOfferCopilotComponentStrings;
  export = strings;
}
