...
import type { IResearchCompetitivePositionProps } from './IResearchCompetitivePositionProps';
 ...
 */
export default function ResearchCompetitivePosition(props: IResearchCompetitivePositionProps): React.ReactElement {
  const {
