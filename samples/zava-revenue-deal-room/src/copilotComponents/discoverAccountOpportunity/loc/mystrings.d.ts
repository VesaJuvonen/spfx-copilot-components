declare interface IDiscoverAccountOpportunityCopilotComponentStrings {
...
declare module 'DiscoverAccountOpportunityCopilotComponentStrings' {
  const strings: IDiscoverAccountOpportunityCopilotComponentStrings;
  export = strings;
}
