...
import type { IDiscoverAccountOpportunityProps } from './IDiscoverAccountOpportunityProps';
 ...
 */
export default function DiscoverAccountOpportunity(props: IDiscoverAccountOpportunityProps): React.ReactElement {
  const {
