...
import type { IReviewDealExceptionProps } from './IReviewDealExceptionProps';
 ...
 */
export default function ReviewDealException(props: IReviewDealExceptionProps): React.ReactElement {
  const {
