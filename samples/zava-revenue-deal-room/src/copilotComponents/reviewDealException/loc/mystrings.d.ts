declare interface IReviewDealExceptionCopilotComponentStrings {
...
declare module 'ReviewDealExceptionCopilotComponentStrings' {
  const strings: IReviewDealExceptionCopilotComponentStrings;
  export = strings;
}
