declare interface IReviewMeetingCommitmentsCopilotComponentStrings {
...
declare module 'ReviewMeetingCommitmentsCopilotComponentStrings' {
  const strings: IReviewMeetingCommitmentsCopilotComponentStrings;
  export = strings;
}
