...
import type { IBuildAccountBriefProps } from './IBuildAccountBriefProps';
 ...
 */
export default function BuildAccountBrief(props: IBuildAccountBriefProps): React.ReactElement {
  const {
