declare interface IBuildAccountBriefCopilotComponentStrings {
...
declare module 'BuildAccountBriefCopilotComponentStrings' {
  const strings: IBuildAccountBriefCopilotComponentStrings;
  export = strings;
}
