declare interface IMySitesGroupInfoCopilotComponentStrings {
...
declare module 'MySitesGroupInfoCopilotComponentStrings' {
  const strings: IMySitesGroupInfoCopilotComponentStrings;
  export = strings;
}
