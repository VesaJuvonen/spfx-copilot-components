declare interface IDetectSpendLeakageCopilotComponentStrings {
...
declare module 'DetectSpendLeakageCopilotComponentStrings' {
  const strings: IDetectSpendLeakageCopilotComponentStrings;
  export = strings;
}
