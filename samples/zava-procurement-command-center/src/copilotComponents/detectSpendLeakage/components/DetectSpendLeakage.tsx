...
import type { IDetectSpendLeakageProps } from './IDetectSpendLeakageProps';
 ...
 */
export default function DetectSpendLeakage(props: IDetectSpendLeakageProps): React.ReactElement {
  const {
