declare interface IPlanSupplierRiskMitigationCopilotComponentStrings {
...
declare module 'PlanSupplierRiskMitigationCopilotComponentStrings' {
  const strings: IPlanSupplierRiskMitigationCopilotComponentStrings;
  export = strings;
}
