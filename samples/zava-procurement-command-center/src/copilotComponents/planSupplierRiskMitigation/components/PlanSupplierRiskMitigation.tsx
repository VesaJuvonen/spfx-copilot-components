...
import type { IPlanSupplierRiskMitigationProps } from './IPlanSupplierRiskMitigationProps';
 ...
 */
export default function PlanSupplierRiskMitigation(props: IPlanSupplierRiskMitigationProps): React.ReactElement {
  const {
