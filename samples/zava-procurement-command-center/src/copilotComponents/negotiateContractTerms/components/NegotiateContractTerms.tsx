...
import type { INegotiateContractTermsProps } from './INegotiateContractTermsProps';
 ...
 */
export default function NegotiateContractTerms(props: INegotiateContractTermsProps): React.ReactElement {
  const {
