declare interface INegotiateContractTermsCopilotComponentStrings {
...
declare module 'NegotiateContractTermsCopilotComponentStrings' {
  const strings: INegotiateContractTermsCopilotComponentStrings;
  export = strings;
}
