...
import type { ICreatePurchaseIntentProps } from './ICreatePurchaseIntentProps';
 ...
 */
export default function CreatePurchaseIntent(props: ICreatePurchaseIntentProps): React.ReactElement {
  const {
