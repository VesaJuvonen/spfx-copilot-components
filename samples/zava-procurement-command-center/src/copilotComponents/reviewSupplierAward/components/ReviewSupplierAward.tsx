...
import type { IReviewSupplierAwardProps } from './IReviewSupplierAwardProps';
 ...
 */
export default function ReviewSupplierAward(props: IReviewSupplierAwardProps): React.ReactElement {
  const {
