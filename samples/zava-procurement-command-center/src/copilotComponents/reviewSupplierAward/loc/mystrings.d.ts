declare interface IReviewSupplierAwardCopilotComponentStrings {
...
declare module 'ReviewSupplierAwardCopilotComponentStrings' {
  const strings: IReviewSupplierAwardCopilotComponentStrings;
  export = strings;
}
