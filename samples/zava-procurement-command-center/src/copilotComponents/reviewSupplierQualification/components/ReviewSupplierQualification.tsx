...
import type { IReviewSupplierQualificationProps } from './IReviewSupplierQualificationProps';
 ...
 */
export default function ReviewSupplierQualification(props: IReviewSupplierQualificationProps): React.ReactElement {
  const {
