declare interface ICompareBuyingOptionsCopilotComponentStrings {
...
declare module 'CompareBuyingOptionsCopilotComponentStrings' {
  const strings: ICompareBuyingOptionsCopilotComponentStrings;
  export = strings;
}
