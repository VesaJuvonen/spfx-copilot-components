...
import type { ICompareBuyingOptionsProps } from './ICompareBuyingOptionsProps';
 ...
 */
export default function CompareBuyingOptions(props: ICompareBuyingOptionsProps): React.ReactElement {
  const {
