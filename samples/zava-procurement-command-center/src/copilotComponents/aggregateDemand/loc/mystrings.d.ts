declare interface IAggregateDemandCopilotComponentStrings {
...
declare module 'AggregateDemandCopilotComponentStrings' {
  const strings: IAggregateDemandCopilotComponentStrings;
  export = strings;
}
