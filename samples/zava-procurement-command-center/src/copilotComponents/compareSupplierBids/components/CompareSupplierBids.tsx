...
import type { ICompareSupplierBidsProps } from './ICompareSupplierBidsProps';
 ...
 */
export default function CompareSupplierBids(props: ICompareSupplierBidsProps): React.ReactElement {
  const {
