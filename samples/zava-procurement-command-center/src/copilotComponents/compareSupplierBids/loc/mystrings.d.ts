declare interface ICompareSupplierBidsCopilotComponentStrings {
...
declare module 'CompareSupplierBidsCopilotComponentStrings' {
  const strings: ICompareSupplierBidsCopilotComponentStrings;
  export = strings;
}
