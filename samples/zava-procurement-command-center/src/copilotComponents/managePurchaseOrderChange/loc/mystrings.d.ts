declare interface IManagePurchaseOrderChangeCopilotComponentStrings {
...
declare module 'ManagePurchaseOrderChangeCopilotComponentStrings' {
  const strings: IManagePurchaseOrderChangeCopilotComponentStrings;
  export = strings;
}
