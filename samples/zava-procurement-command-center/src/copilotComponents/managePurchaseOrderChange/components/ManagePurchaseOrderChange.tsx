...
import type { IManagePurchaseOrderChangeProps } from './IManagePurchaseOrderChangeProps';
 ...
 */
export default function ManagePurchaseOrderChange(props: IManagePurchaseOrderChangeProps): React.ReactElement {
  const {
