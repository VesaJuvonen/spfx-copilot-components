...
import type { IReviewPurchaseRequestProps } from './IReviewPurchaseRequestProps';
 ...
 */
export default function ReviewPurchaseRequest(props: IReviewPurchaseRequestProps): React.ReactElement {
  const {
