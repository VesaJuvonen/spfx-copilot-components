declare interface IReviewPurchaseRequestCopilotComponentStrings {
...
declare module 'ReviewPurchaseRequestCopilotComponentStrings' {
  const strings: IReviewPurchaseRequestCopilotComponentStrings;
  export = strings;
}
