...
import type { ICheckPurchasePolicyProps } from './ICheckPurchasePolicyProps';
 ...
 */
export default function CheckPurchasePolicy(props: ICheckPurchasePolicyProps): React.ReactElement {
  const {
