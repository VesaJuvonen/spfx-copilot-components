declare interface ICheckPurchasePolicyCopilotComponentStrings {
...
declare module 'CheckPurchasePolicyCopilotComponentStrings' {
  const strings: ICheckPurchasePolicyCopilotComponentStrings;
  export = strings;
}
