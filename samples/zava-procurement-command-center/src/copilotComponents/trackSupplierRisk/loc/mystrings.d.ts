declare interface ITrackSupplierRiskCopilotComponentStrings {
...
declare module 'TrackSupplierRiskCopilotComponentStrings' {
  const strings: ITrackSupplierRiskCopilotComponentStrings;
  export = strings;
}
