...
import type { ITrackSupplierRiskProps } from './ITrackSupplierRiskProps';
 ...
 */
export default function TrackSupplierRisk(props: ITrackSupplierRiskProps): React.ReactElement {
  const {
