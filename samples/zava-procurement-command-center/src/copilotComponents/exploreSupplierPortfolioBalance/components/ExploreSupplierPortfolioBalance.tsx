...
import type { IExploreSupplierPortfolioBalanceProps } from './IExploreSupplierPortfolioBalanceProps';
 ...
 */
export default function ExploreSupplierPortfolioBalance(props: IExploreSupplierPortfolioBalanceProps): React.ReactElement {
  const {
