...
export interface IExploreSupplierPortfolioBalanceStrings {
...
export interface IExploreSupplierPortfolioBalanceProps {
  ...
  strings: IExploreSupplierPortfolioBalanceStrings;
}
