declare interface IExploreSpendPerformanceCopilotComponentStrings {
...
declare module 'ExploreSpendPerformanceCopilotComponentStrings' {
  const strings: IExploreSpendPerformanceCopilotComponentStrings;
  export = strings;
}
