...
import type { IExploreSpendPerformanceProps } from './IExploreSpendPerformanceProps';
 ...
 */
export default function ExploreSpendPerformance(props: IExploreSpendPerformanceProps): React.ReactElement {
  const {
