declare interface ITrackLeakageRecoveryCopilotComponentStrings {
...
declare module 'TrackLeakageRecoveryCopilotComponentStrings' {
  const strings: ITrackLeakageRecoveryCopilotComponentStrings;
  export = strings;
}
