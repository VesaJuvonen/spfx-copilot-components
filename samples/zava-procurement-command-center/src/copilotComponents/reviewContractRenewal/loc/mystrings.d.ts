declare interface IReviewContractRenewalCopilotComponentStrings {
...
declare module 'ReviewContractRenewalCopilotComponentStrings' {
  const strings: IReviewContractRenewalCopilotComponentStrings;
  export = strings;
}
