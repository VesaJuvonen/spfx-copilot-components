...
import type { IReviewContractRenewalProps } from './IReviewContractRenewalProps';
 ...
 */
export default function ReviewContractRenewal(props: IReviewContractRenewalProps): React.ReactElement {
  const {
