declare interface IOnboardSupplierCopilotComponentStrings {
...
declare module 'OnboardSupplierCopilotComponentStrings' {
  const strings: IOnboardSupplierCopilotComponentStrings;
  export = strings;
}
