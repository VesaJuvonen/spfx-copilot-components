declare interface IExploreSupplier360CopilotComponentStrings {
...
declare module 'ExploreSupplier360CopilotComponentStrings' {
  const strings: IExploreSupplier360CopilotComponentStrings;
  export = strings;
}
