...
import type { IExploreSupplier360Props } from './IExploreSupplier360Props';
 ...
 */
export default function ExploreSupplier360(props: IExploreSupplier360Props): React.ReactElement {
  const {
