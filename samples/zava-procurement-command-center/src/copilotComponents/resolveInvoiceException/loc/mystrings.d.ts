declare interface IResolveInvoiceExceptionCopilotComponentStrings {
...
declare module 'ResolveInvoiceExceptionCopilotComponentStrings' {
  const strings: IResolveInvoiceExceptionCopilotComponentStrings;
  export = strings;
}
