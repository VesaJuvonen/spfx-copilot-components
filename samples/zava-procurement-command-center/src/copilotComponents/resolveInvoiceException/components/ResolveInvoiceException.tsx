...
import type { IResolveInvoiceExceptionProps } from './IResolveInvoiceExceptionProps';
 ...
 */
export default function ResolveInvoiceException(props: IResolveInvoiceExceptionProps): React.ReactElement {
  const {
