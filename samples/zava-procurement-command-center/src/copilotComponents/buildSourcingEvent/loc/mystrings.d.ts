declare interface IBuildSourcingEventCopilotComponentStrings {
...
declare module 'BuildSourcingEventCopilotComponentStrings' {
  const strings: IBuildSourcingEventCopilotComponentStrings;
  export = strings;
}
