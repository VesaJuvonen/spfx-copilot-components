...
import type { IBuildSourcingEventProps } from './IBuildSourcingEventProps';
 ...
 */
export default function BuildSourcingEvent(props: IBuildSourcingEventProps): React.ReactElement {
  const {
