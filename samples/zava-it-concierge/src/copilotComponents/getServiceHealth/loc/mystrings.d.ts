declare interface IGetServiceHealthCopilotComponentStrings {
...
declare module 'GetServiceHealthCopilotComponentStrings' {
  const strings: IGetServiceHealthCopilotComponentStrings;
  export = strings;
}
