declare interface IGetLicenseReclaimCopilotComponentStrings {
...
declare module 'GetLicenseReclaimCopilotComponentStrings' {
  const strings: IGetLicenseReclaimCopilotComponentStrings;
  export = strings;
}
