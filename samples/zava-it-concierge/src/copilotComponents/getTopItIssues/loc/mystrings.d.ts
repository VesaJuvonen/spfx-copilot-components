declare interface IGetTopItIssuesCopilotComponentStrings {
...
declare module 'GetTopItIssuesCopilotComponentStrings' {
  const strings: IGetTopItIssuesCopilotComponentStrings;
  export = strings;
}
