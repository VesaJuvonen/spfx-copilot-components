declare interface IConfigureDeviceRequestCopilotComponentStrings {
...
declare module 'ConfigureDeviceRequestCopilotComponentStrings' {
  const strings: IConfigureDeviceRequestCopilotComponentStrings;
  export = strings;
}
