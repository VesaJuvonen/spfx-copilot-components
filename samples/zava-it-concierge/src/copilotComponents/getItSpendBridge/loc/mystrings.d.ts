declare interface IGetItSpendBridgeCopilotComponentStrings {
...
declare module 'GetItSpendBridgeCopilotComponentStrings' {
  const strings: IGetItSpendBridgeCopilotComponentStrings;
  export = strings;
}
