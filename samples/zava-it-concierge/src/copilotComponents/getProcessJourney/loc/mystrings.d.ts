declare interface IGetProcessJourneyCopilotComponentStrings {
...
declare module 'GetProcessJourneyCopilotComponentStrings' {
  const strings: IGetProcessJourneyCopilotComponentStrings;
  export = strings;
}
