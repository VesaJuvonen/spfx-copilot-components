declare interface ICorrelateMajorIncidentCopilotComponentStrings {
...
declare module 'CorrelateMajorIncidentCopilotComponentStrings' {
  const strings: ICorrelateMajorIncidentCopilotComponentStrings;
  export = strings;
}
