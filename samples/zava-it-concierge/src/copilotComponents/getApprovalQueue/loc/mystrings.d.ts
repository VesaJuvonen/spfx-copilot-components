declare interface IGetApprovalQueueCopilotComponentStrings {
...
declare module 'GetApprovalQueueCopilotComponentStrings' {
  const strings: IGetApprovalQueueCopilotComponentStrings;
  export = strings;
}
