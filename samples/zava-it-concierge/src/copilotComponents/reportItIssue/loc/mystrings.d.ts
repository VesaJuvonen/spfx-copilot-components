declare interface IReportItIssueCopilotComponentStrings {
...
declare module 'ReportItIssueCopilotComponentStrings' {
  const strings: IReportItIssueCopilotComponentStrings;
  export = strings;
}
