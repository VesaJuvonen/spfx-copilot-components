declare interface IGetDeviceHealthCopilotComponentStrings {
...
declare module 'GetDeviceHealthCopilotComponentStrings' {
  const strings: IGetDeviceHealthCopilotComponentStrings;
  export = strings;
}
