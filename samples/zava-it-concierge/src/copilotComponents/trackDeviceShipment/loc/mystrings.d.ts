declare interface ITrackDeviceShipmentCopilotComponentStrings {
...
declare module 'TrackDeviceShipmentCopilotComponentStrings' {
  const strings: ITrackDeviceShipmentCopilotComponentStrings;
  export = strings;
}
