declare interface IDraftDeviceJustificationCopilotComponentStrings {
...
declare module 'DraftDeviceJustificationCopilotComponentStrings' {
  const strings: IDraftDeviceJustificationCopilotComponentStrings;
  export = strings;
}
