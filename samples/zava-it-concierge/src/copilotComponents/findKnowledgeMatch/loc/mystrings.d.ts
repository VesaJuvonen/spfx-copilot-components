declare interface IFindKnowledgeMatchCopilotComponentStrings {
...
declare module 'FindKnowledgeMatchCopilotComponentStrings' {
  const strings: IFindKnowledgeMatchCopilotComponentStrings;
  export = strings;
}
