declare interface IReviewDeviceApprovalCopilotComponentStrings {
...
declare module 'ReviewDeviceApprovalCopilotComponentStrings' {
  const strings: IReviewDeviceApprovalCopilotComponentStrings;
  export = strings;
}
