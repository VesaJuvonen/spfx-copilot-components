declare interface IPreviewRequestCostCopilotComponentStrings {
...
declare module 'PreviewRequestCostCopilotComponentStrings' {
  const strings: IPreviewRequestCostCopilotComponentStrings;
  export = strings;
}
