declare interface IReviewPolicyExceptionCopilotComponentStrings {
...
declare module 'ReviewPolicyExceptionCopilotComponentStrings' {
  const strings: IReviewPolicyExceptionCopilotComponentStrings;
  export = strings;
}
