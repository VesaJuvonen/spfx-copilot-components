declare interface IGetRefreshEligibilityCopilotComponentStrings {
...
declare module 'GetRefreshEligibilityCopilotComponentStrings' {
  const strings: IGetRefreshEligibilityCopilotComponentStrings;
  export = strings;
}
