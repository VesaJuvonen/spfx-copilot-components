declare interface IPlanRefreshWavesCopilotComponentStrings {
...
declare module 'PlanRefreshWavesCopilotComponentStrings' {
  const strings: IPlanRefreshWavesCopilotComponentStrings;
  export = strings;
}
