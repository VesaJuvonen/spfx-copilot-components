declare interface IMyDeviceStatusCopilotComponentStrings {
...
declare module 'MyDeviceStatusCopilotComponentStrings' {
  const strings: IMyDeviceStatusCopilotComponentStrings;
  export = strings;
}
