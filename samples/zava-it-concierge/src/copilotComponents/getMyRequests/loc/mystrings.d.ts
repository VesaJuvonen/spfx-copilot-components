declare interface IGetMyRequestsCopilotComponentStrings {
...
declare module 'GetMyRequestsCopilotComponentStrings' {
  const strings: IGetMyRequestsCopilotComponentStrings;
  export = strings;
}
