declare interface IRunDeviceDiagnosticsCopilotComponentStrings {
...
declare module 'RunDeviceDiagnosticsCopilotComponentStrings' {
  const strings: IRunDeviceDiagnosticsCopilotComponentStrings;
  export = strings;
}
