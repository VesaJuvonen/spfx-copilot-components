declare interface IGenerateItBriefCopilotComponentStrings {
...
declare module 'GenerateItBriefCopilotComponentStrings' {
  const strings: IGenerateItBriefCopilotComponentStrings;
  export = strings;
}
