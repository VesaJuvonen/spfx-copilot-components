declare interface IGetDeviceAgeDistributionCopilotComponentStrings {
...
declare module 'GetDeviceAgeDistributionCopilotComponentStrings' {
  const strings: IGetDeviceAgeDistributionCopilotComponentStrings;
  export = strings;
}
