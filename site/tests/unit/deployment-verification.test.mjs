...
describe('deployment verification', () => {
  it('records the commit and exact catalog content in the build artifact', async () => {
  ...
  it('rejects a stale deployment even when all requests return successfully', async () => {
    const catalogContent = `${JSON.stringify(catalog)}\n`;
    const marker = {
      version: 1,
